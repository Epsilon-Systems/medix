	...
	protected function getListQuery() {
		...
		$query->select(
			$this->getState(
				...
				'a.id, a.checked_out, a.checked_out_time, a.catid,
				 ...
				 a.name, a.avatar, a.email, a.position, a.company, a.website, a.testimonial,a.video'
			)
		);
		...
		if (!empty($search)) {
			if (stripos($search, 'id:') === 0) {
				...
				$query->where('(a.name LIKE ' . $search . ' OR a.email LIKE ' . $search . ' OR a.testimonial LIKE ' . $search . ')');
			}
		}
