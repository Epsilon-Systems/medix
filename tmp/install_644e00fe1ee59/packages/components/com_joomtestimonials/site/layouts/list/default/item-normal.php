...
<div
        class="testiItem testiAnimate p-3 <?php echo $customClass.' '.$textAlign.' '. ($show_avatar ? ' testi-avatar-' . $avatar_position : ''); ?> "
>
    ...
    <div class="testi-item testi-item-<?php echo $item->id; ?>">
            ...
            <?php if($show_vote && $vote_position == 3): // vote before avatar?>
            ...
            <?php endif; ?>
            <?php if($show_vote && $vote_position == 2): // vote after avatar?>
                <div class="testi-vote">
                    <?php echo $vote; ?>
                </div>
            <?php endif;?>
            ...
            <div class="testi-quote">
                ...
                <?php endif; ?>
                <?php if($show_vote && $vote_position == 5): // vote Before Testimonial ?>
                    <div class="testi-vote">
                        <?php echo $vote; ?>
                    </div>
                <?php endif;?>
                ...
                <?php  if($cfields_position == 1) : // custom fields position after testimonial text?>
                    <?php echo $cfieldsLayout; ?>
                <?php endif; ?>
                <?php if($show_vote && $vote_position == 4): // vote after Testimonial ?>
                    <div class="testi-vote">
                        <?php echo $vote; ?>
                    </div>
                <?php endif;?>
            </div>
            <?php if($show_vote && $vote_position == 1):  // vote Before Title?>
                <div class="testi-vote">
                    <?php echo $vote; ?>
                </div>
            <?php endif;?>
            ...
            <?php if($show_vote && $vote_position == 0):  // After Title?>
                <div class="testi-vote">
                    <?php echo $vote; ?>
                </div>
            <?php endif;?>
            ...
            <?php endif; ?>
            <?php if ($permalink) : ?>
                <div class="permalink my-2"><a class="<?php echo $permalink_class ?>" href ="<?php echo JRoute::_(JoomtestimonialsHelperRoute::getTestimonialRoute($item->id,$item->name));?>"><?php echo JText::_('COM_JOOMTESTIMONIALS_PERMALINK')?></a></div>
            <?php endif;?>
