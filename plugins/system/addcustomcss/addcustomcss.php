...
{	
	...
	function onBeforeCompileHead()
	{
		...
		if (!empty($this->params->get('custom_css_file_path_1')))
		{
			...
			if (($app->isClient('site') && strcmp($custom_css_file_mode_1, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_css_file_mode_1, 'back-end')==0) || strcmp($custom_css_file_mode_1, 'both')==0)
			{
		...
		if (!empty($this->params->get('custom_css_file_path_2')))
		{
			...
			if (($app->isClient('site') && strcmp($custom_css_file_mode_2, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_css_file_mode_2, 'back-end')==0) || strcmp($custom_css_file_mode_2, 'both')==0)
			{
		...
		if (!empty($this->params->get('custom_css_file_path_3')))
		{
			...
			if (($app->isClient('site') && strcmp($custom_css_file_mode_3, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_css_file_mode_3, 'back-end')==0) || strcmp($custom_css_file_mode_3, 'both')==0)
			{
